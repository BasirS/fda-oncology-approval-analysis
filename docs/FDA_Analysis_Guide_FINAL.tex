...
\bottomrule
\end{tabular}
\caption{ANCOVA table with expedited program covariates. Note: Review Designation, Regulatory Era, and Interaction terms were included in the model but are not listed in this summary table. The full model included 10 degrees of freedom: Intercept (1) + Therapeutic Area (1) + Review Designation (1) + Regulatory Era (3) + Interaction (1) + Accelerated Approval (1) + Fast Track (1) + Orphan Drug (1).}
\end{table}
